...
**Status:** Nightshift 3.0.8 is published on `main`, with implementation and required Windows acceptance complete. The [acceptance report](.nightshift/reports/v3-acceptance-272m-20260910.md) records the evidence and its qualifications. See [VISION.md](VISION.md), [WORKFLOW.md](WORKFLOW.md) and the [v3 feature](.nightshift/features/nightshift-v3.md) for the supported scope.

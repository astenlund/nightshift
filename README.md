...
**Status:** Nightshift 3.2.2 is in development, adding recoverable setup and standalone unwrap writes. Original bytes survive partial writes, unfinished repairs are visible to setup and Ready, and overlapping writers cannot share cleanup authority. See the [recovery reference](internal/UNWRAP.md) and [acceptance report](.nightshift/reports/recoverable-unwrap-20260921.md) for behavior and verification limits. Its published baseline is 3.2.1, which clarified strong-reviewer availability and repair pauses. Earlier [handover](.nightshift/reports/handover-transition-and-morning-report-20260919.md), [retained-release](.nightshift/reports/retained-plugin-releases-20260914.md) and [v3 MVP](.nightshift/reports/v3-acceptance-272m-20260910.md) reports preserve their evidence and qualifications. See [VISION.md](VISION.md), [WORKFLOW.md](WORKFLOW.md) and the [v3 feature](.nightshift/features/nightshift-v3.md) for supported scope.

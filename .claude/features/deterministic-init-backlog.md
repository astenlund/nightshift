...
Other top-level Markdown files and `.claude/plans/` contents remain outside mechanical repair scope. `.claude/quick_wins/` and Quick Win breakout prose remain outside this feature until Pick-time breakouts extends the controller.

...
- Follows the breakout-dependency-drift bug fix (shipped 2026-08-22), which rewrote the `init-backlog` `## Requires lines` templates to the two-line convention and added a legacy-section replace rule; this feature relocates the rewritten templates.

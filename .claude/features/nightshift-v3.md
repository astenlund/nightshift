...
Draft for agreement, 2026-09-07. This feature consolidates the agreed [vision](../../VISION.md), [workflow](../../WORKFLOW.md), and [migration assessment](../../V3-MIGRATION.md). It defines the first v3 release; implementation is not yet authorized and no v3 capability is claimed as shipped.
...
This draft remains in the current backlog pending agreement and independent assessment. Its file moves with the later `.nightshift` migration.

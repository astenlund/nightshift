...
The [candidate acceptance report](../reports/v3-acceptance-20260908.md) records observed native continuation/compaction, deterministic coverage, remaining model-owned acceptance and the initial campaign's budget boundary. No incomplete case is treated as a passed MVP requirement.

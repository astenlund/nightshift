...
The [candidate acceptance report](../reports/v3-acceptance-32m-20260908.md) records observed native continuation/compaction, substantial Codex delivery, standalone Fable documentation, deterministic coverage and remaining acceptance under the authorized 32M total. Historical failed outcomes remain intact beside independently verified adjudications. No incomplete requirement is treated as passed.

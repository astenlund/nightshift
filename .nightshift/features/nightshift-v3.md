...
The [candidate acceptance report](../reports/v3-acceptance-64m-20260908.md) continues the historical 32M checkpoint with both-host substantial delivery and standalone documentation, observed automatic compaction, and the remaining acceptance under the authorized 64M total. Historical failed outcomes remain intact beside independently verified adjudications. No incomplete requirement is treated as passed.

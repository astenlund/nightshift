---
name: structured-model-teams
description: Explore explicit multi-model team arrangements beyond the v3 controller's assignment judgment
metadata:
  type: feature
status: exploring
---

# Structured model teams

...
description: Retained capabilities outside the first Nightshift v3 release
metadata:
  type: feature
status: exploring
---
...
These capabilities are deliberately outside [the v3 MVP](nightshift-v3.md). They remain future design work, not prerequisites for the supported Windows lifecycle.

- Verify macOS and Linux behavior.
- Transfer active control between hosts safely.
- Support multiple independent runs in one checkout with clear ownership.

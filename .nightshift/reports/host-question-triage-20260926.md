...
Both the unattended run's final message and its re-presentation to the returning user ended with the two follow-ups listed under "Pending follow-ups" and "Are you ready to triage these two follow-ups?". After "Yes, go ahead." the controller recorded the delivery and called AskUserQuestion with "Follow-up 1 of 2: rename NOTES.md to DECISIONS.md? ..." and the options Track (Recommended), Fix now and Skip, each with its effect, then said the second follow-up would follow the answer. One observation on one model; Codex was not run. Review afterwards reordered the report's contents list so the attended or unattended statement precedes the unresolved items, the order this fixture already produced, added the no-decision-pending alternative to the notice and the skill, removed a clause that let the first reply decide a follow-up, defined the not-ready reply as leaving the follow-ups pending, and made the delivered-report notice ask whether the user is ready unless they have asked to triage; those wording changes were not observed separately.
